$(function(){
    ...
    if($.cookie("isClose") != 'yes'){
        ...
        $('.experience-close').on('click',function(){
            ...
            $.cookie("isClose",'yes',{ expires:365,path: '/'});		//一天
        })
        $('.experienceGrants-mask').on('click',function(){
            $('.experienceGrants-box').hide();
            $('.experienceGrants-mask').hide();

            //$.cookie("isClose",'yes',{ expires:1/8640,path: '/', domain: 'jquery.com', secure: true});	//测试十秒
            $.cookie("isClose",'yes',{ expires:365,path: '/', domain: 'http://localhost:63342/less/12-8/index.html', secure: true});		//一天
        });
    }
