...
(function (b, c, d) {
    ...
    c.extend(c.powerSwitch, {
        getRelative: function (f, h) {
            ...
            var h = "translate" + e + "(" + f + ")";
            a ? g.css("webkitTransform", h).css("transform", h) : g.css(e == "X" ? {left: f} : {top: f})
            ...
            var i = function (t, r, s) {
                ...
                if (a) {
                    ...
                    t[l ? "css" : "animate"](r == "X" ? {left: s} : {top: s}, k.duration)
                }
            };
                ...
                if (k.container && k.container.length) {
                    ...
                    if (k.direction == "vertical") {
                        if (f.scrollHeight - f.clientHeight >= Math.max(m.top, 1)) {
                            k.animation == "auto" ? k.container.animate({scrollTop: m.top}) : k.container.scrollTop(m.top)
                        } else {
                            i(k.container, "Y", -1 * m.top)
                        }
                    } else {
                        if (f.scrollWidth - f.clientWidth >= Math.max(m.left, 1)) {
                            k.animation == "auto" ? k.container.animate({scrollLeft: m.left}) : k.container.scrollLeft(m.left)
                        } else {
                        ...
                        if (z.container && l > h) {
                            if (C == 0) {
                                ...
                                if (F < 0) {
                                    ...
                                    c.powerSwitch.animation(null, null, c.extend({}, z, {animation: "none"}));
                                    F = B + l - h
                                }
                            } else {
                                if (C == 1) {
