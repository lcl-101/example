...
/*获得相对于body左上角的位置
*offset是获取到body的距离，如果他的父元素有定位属性，则获取到的是到其父元素的距离；
* obj  要获取的对象
* */
function offset(obj){
    var arr=[obj];
    ...
    while(parent.nodeName!=="BODY"){//不知道要循环多少次，所以用while,找有定位属性的父元素
    ...
    for(var i=0;i<arr.length;i++){
        ...
        if(i>0) {
         //注意当无边框的时候是undefined，会报错   ||0             //borderLeftWidth左边框的值   //borderTopWidth上边框的值
